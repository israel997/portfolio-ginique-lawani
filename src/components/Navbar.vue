<template>
  <nav class="flex justify-between items-center mb-12 md:mb-20 bg-white/5 backdrop-blur-lg border border-white/10 rounded-full px-4 md:px-6 py-3 md:py-4 shadow-xl">
